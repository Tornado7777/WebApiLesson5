...
namespace MetricsManager.Client
{
    ...
    public partial class MetricsManagerClient 
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task To4Async(int agentId, string fromTime, string toTime)
        {
            return To4Async(agentId, fromTime, toTime, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task To4Async(int agentId, string fromTime, string toTime, System.Threading.CancellationToken cancellationToken)
        {
            if (agentId == null)
                throw new System.ArgumentNullException("agentId");
